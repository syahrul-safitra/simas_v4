...
@section('container')
    <div class="col-12">
        <h4 class="mb-2"><i class="bi bi-envelope"></i> Arsip Disposisi</h4>
        {{-- Session Message --}}
        ...
        <div class="bg-light rounded h-100 p-4">
            <div class="table-responsive">
                <table class="table table-hover" id="table-arsip-disposisi" style="color:black">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($disposisis as $disposisi)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('pengguna/arsipdisposisi/' . $disposisi->id) }}" class="btn btn-success"
