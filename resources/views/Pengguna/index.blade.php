            ...
            <div class="table-responsive">
                <table class="table table-hover" style="color:black">
                    ...
                    <tbody>
                        ...
                        @foreach ($diteruskan1 as $diteruskan)
                            <tr>
                                <th scope="row">{{ $loop->iteration }}</th>
                                <td>{{ $diteruskan->disposisi1->suratMasuk->asal_surat }}</td>
                                <td>{{ $diteruskan->disposisi1->suratMasuk->status }}</td>
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a class="fs-4" style="color: red"
                                            href="{{ asset('file/' . $diteruskan->disposisi1->suratMasuk->file) }}"><i
                                                class="bi bi-file-earmark-pdf-fill"></i></a>
                                    </div>
                                </td>
                                <td>
                                    <a href="{{ url('pengguna/disposisi2/' . $diteruskan->disposisi1->id) }}"
